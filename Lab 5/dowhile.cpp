...
int main()
{
	...
	do
	{
		...
		switch (beverage) {
			...
			default: cout << "Invalid selection" << endl;// Fill in the code to write a message
						// indicating an invalid selection.
				 cout << " Try again please" << endl;
		}

	} until (beverage == 'E' || beverage == 'e');	// Fill in the code to finish the do-while statement with the
